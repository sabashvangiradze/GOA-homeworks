# Input ნიშნავს იმ მონაცემს ან ინფორმაციას, რომელსაც სისტემა იღებს. მაგალითად კლავიატურა,მაუსი,მიკროფონი.
# Output არის ის შედეგი ან ინფორმაცია, რასაც სისტემა გვიბრუნებს input-ის დამუშავების შემდეგ. მაგალითად მონიტორი,პრინტერი,დინამიკი.
